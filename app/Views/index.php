...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>/public/dist/css/estilos.css" />
...
<body>
  ...
  <div class="br-logo m-auto text-uppercase">
    <a href="<?php echo base_url(); ?>/inicio"><span class="m-auto">[</span>Café Raider<span>]</span></a>
  </div>
  <!-- fin logo -->
